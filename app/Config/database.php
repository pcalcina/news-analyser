...
#	define('DEFAULT_DB', TMP.'db'.DS.'protestos.sqlite');
#	define('DEFAULT_DB', 'webroot/protestos.sqlite');


	public $default = array(
		'datasource' => 'Database/Sqlite',
		'persistent' => false,
		'database' => '/var/www/html/news-analyser/app/webroot/protestos.sqlite',
		'prefix' => '',
		'encoding' => 'utf8',
	);
