...
<div class="actions">
	<ul>
		<li><?php if ($this->request->referer() != '/'): ?>
       		        <?php echo $this->Html->link(__('< Voltar'), 
    		            $this->request->referer()); ?>
		        <?php else: ?>
    		        <?php echo $this->Html->link(__('< Todos os eventos'), 
...
<?php echo $this->Form->create('Event', array('id' => 'frm_create_event')); ?>
	...
	<table>
    	<tr>
        	<td style='width:15%'><?php echo $this->Form->input('date',  
        ...
        <tr>
            ...
            <td><?php echo $this->Form->end(__('Criar evento')); ?></td>
        </tr>
    </table>
	</fieldset>
</div>
